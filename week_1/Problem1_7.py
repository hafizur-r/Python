...
#%%
def problem1_7():
    b_1=float(input("Enter the length of one of the bases: "))
    b_2=float(input("Enter the length of the bases: "))
    h=float(input("Enter the height: "))
    area = 0.5*(b_1+b_2)*h
    print("The area of a trapezoid with bases", b_1, "and", b_2, "and height", h, "is", area)
#%%
"""
