...
def areatriangle(b,h):
    """compute the area of a triangle of given base and height"""
    area=0.5*b*h
...
def celsius_to_fahrenheit(temp):
    newTemp=((9/5)*temp)+32
    print("Thedegrees Celsius temperature",temp,"is equivalent to",newTemp,end='')
    print(" Fahrenheit")
